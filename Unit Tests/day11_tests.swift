...
class day11_tests: XCTestCase {

    var input: [String]!

    func testExampleOne() throws {

        let layout = SeatLayout(input: ["L.LL.LL.LL",
                                        "LLLLLLL.LL",
                                        "L.L.L..L..",
                                        "LLLL.LL.LL",
                                        "L.LL.LL.LL",
        ...
        let result = layout.stable()
        XCTAssertEqual(result, 37)
    }

    func testProblemOne() throws {

        let layout = SeatLayout(input: self.input)
        let result = layout.stable()
        print("Day 11.1 The answer is: \(result)")
    }
    ...
    func testProblemTwo() throws {
        ...
        let layout = SeatLayout(input: self.input)
        let result = layout.stable2()
        print("Day 11.2 The answer is: \(result)")
    }
