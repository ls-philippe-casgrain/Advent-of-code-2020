...
class day14_tests: XCTestCase {

    var input: [String]!

    func testExampleOne() throws {

        let prog = Program(input: ["mask = XXXXXXXXXXXXXXXXXXXXXXXXXXXXX1XXXX0X",
                                   "mem[8] = 11",
                                   "mem[7] = 101",
                                   "mem[8] = 0",])

        let result = prog.sumAll()
        XCTAssertEqual(result, 165)
    }

    func testProblemOne() throws {

        let prog = Program(input: self.input)

        let result = prog.sumAll()
        print("Day 14.1 The answer is: \(result)")
    }
...
//    }
    ...
    override func setUpWithError() throws {
        input = ["mask = 1000XX0X0X0X0011XX11110110X101101X01",
                 "mem[17353] = 91550",
                 "mem[3346] = 113780395",
                 "mem[25928] = 15887",
