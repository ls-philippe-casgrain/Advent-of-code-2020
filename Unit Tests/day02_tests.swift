...
class day02_tests: XCTestCase {

    var input: [String]!

    func testDay02_ExampleOne() throws {
        let password = Password(input: ["1-3 a: abcde",
                                        "1-3 b: cdefg",
                                        "2-9 c: ccccccccc"])

        let result = password.numValid()
        XCTAssertEqual(result, 2)
    }

    func testDay02_ProblemOne() throws {
        let password = Password(input: self.input)

        let result = password.numValid()
        print("Day 2.1 The answer is: \(result)")
    }

    func testDay02_ExampleTwo() throws {
        let password = Password(input: ["1-3 a: abcde",
                                        "1-3 b: cdefg",
                                        "2-9 c: ccccccccc"])

        let result = password.numValidNew()
        XCTAssertEqual(result, 1)
    }

    func testDay02_ProblemTwo() throws {
        let password = Password(input: self.input)

        let result = password.numValidNew()
        print("Day 2.2 The answer is: \(result)")
    }
