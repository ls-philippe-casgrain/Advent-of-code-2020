...
class day24_tests: XCTestCase {
    ...
    func testExampleOne() throws {
        ...
        let floor = Floor(input: """
                                 ...
                                 """)
        let result = floor.followInstructions()
        XCTAssertEqual(result, 10)
    }

    func testProblemOne() throws {

        let floor = Floor(input: self.input)
        let result = floor.followInstructions()
        print("Day 24.1 The answer is: \(result)")
    }
    ...
    func testExampleTwo() throws {
        ...
        let floor = Floor(input: """
                                 ...
                                 wseweeenwnesenwwwswnew
                                 """)
        let result = floor.gameOfLife(numIterations: 100)
    ...
    func testProblemTwo() throws {
        let floor = Floor(input: self.input)
        let result = floor.gameOfLife(numIterations: 100)
        print("Day 24.2 The answer is: \(result)")
    }
