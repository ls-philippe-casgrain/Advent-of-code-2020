...
class day07_tests: XCTestCase {

    var input: [String]!

    func testExampleOne() throws {

        let rules = LuggageRules(input: ["light red bags contain 1 bright white bag, 2 muted yellow bags.",
        ...
        XCTAssertEqual(rules.canContain(specificColor: "shiny gold"), 4)
    }

    func testProblemOne() throws {

        let rules = LuggageRules(input: self.input)
        let result = rules.canContain(specificColor: "shiny gold")
        print("Day 7.1 The answer is: \(result)")
    }

    func testExampleTwo() throws {

        let rules = LuggageRules(input: ["shiny gold bags contain 2 dark red bags.",
        ...
        XCTAssertEqual(rules.requiredInside(specificColor: "shiny gold"), 126)
    }

    func testProblemTwo() throws {

        let rules = LuggageRules(input: self.input)
        let result = rules.requiredInside(specificColor: "shiny gold")
        print("Day 7.2 The answer is: \(result)")
    }


    override func setUpWithError() throws {
        input = ["striped tan bags contain 2 light silver bags, 1 drab black bag, 2 clear tan bags, 2 mirrored tan bags.",
